    ...
    <div class="bg-principal">
        <header class="m-auto w-11/12 h-16 flex justify-between items-center">
            ...
            <div class="w-max-1/6">
                ...
                <nav class="absolute -translate-x-full md:hidden items-center md:static w-3/4 h-screen bg-[#23261E] p-6 top-0 left-0 duration-200  shadow-black rounded-xl z-10">
